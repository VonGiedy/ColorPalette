...
function showCopySuccess(iconElement) {
    ...
    if (infoBox) {
        infoBox.style.backgroundColor = "#48bb78";
...
function generatePalette() {
    ...
    const baseSat = Math.floor(Math.random() * 30) + 60;
    const baseLight = Math.floor(Math.random() * 20) + 40;
    ...
    console.log(`Generating based on: ${selectedRule}`);
...
function generateMonochromatic(h, s, l) {
    return [
        ...
        { h: h, s: s, l: l + 20 },
        { h: h, s: s, l: l + 40 },
        { h: h, s: s, l: Math.max(0, l - 20) },
        { h: h, s: Math.max(0, s - 30), l: l + 10 }
    ];
}
...
function generateTriadic(h, s, l) {
    return [
        ...
        { h: (h + 120) % 360, s: s, l: l },
        { h: (h + 240) % 360, s: s, l: l },
        { h: (h + 120) % 360, s: s, l: l + 20 },
        { h: (h + 240) % 360, s: s, l: l - 20 }
    ];
}
